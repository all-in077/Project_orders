...
- **api-gateway** — точка входа, JWT авторизация через gRPC (способ общения с auth-service), reverse proxy для маршрутизации запросов
...
```bash
git clone https://github.com/ник/Project_orders
cd Project_orders
